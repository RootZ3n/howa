...
function validReceipt(): DailyDriverReceiptV1 {
  ...
  return sealReceipt({
    schema_version: "howa.hermes-daily-driver.receipt.v3", trial_id: "ddv1-01-porcelain-parser", trial_suite_version: "hermes-daily-driver.v1.1", run_id: "run-1", timestamp: now,
